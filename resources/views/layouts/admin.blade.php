    ...
    <header class="mn-header navbar-fixed">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-3 " >
            <div class="nav-wrapper row">
                <marquee width="950px" direction="left" behavior="alternate" ><span style="font-size:38px; font-weight:bold;color:#1F7A8C;font-family:'lobster', cursive;">Employee Leave Management System</span>
                </marquee>
        ...
        <div class="side-nav-wrapper">
            ...
            <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                ...
                <li class="no-padding">
                    ...
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="{{route('leaves.create')}}">Add Leave Type</a></li>
                            <li><a href="{{route('leaves.index')}}">Manage Leave Type</a></li>
                        </ul>
                    </div>
                </li>
                <li class="no-padding">
